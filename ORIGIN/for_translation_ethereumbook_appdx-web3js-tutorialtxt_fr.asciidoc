...
=== web3.js Intéraction basique de contrat de façon asynchrone (async)
...
=== Relecture du script de démonstration
...
=== Exécution asynchrone avec await
