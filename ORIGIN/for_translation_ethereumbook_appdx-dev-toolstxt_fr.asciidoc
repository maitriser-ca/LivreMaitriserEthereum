...
== Outils de développement, frameworks, passe:[<span class="keep-together">et librairies</span>]
...
[[truffle_box]]
===== Intégrer un modèle de projet Truffle (Truffle Box)
...
===== Créer une arborescence de projet Truffle
...
===== Migrations de Truffle - comprendre les scripts de déploiement
...
==== EthereumJS helpeth: Un utilitaire de ligne de commande
...
[[ganache]]
==== Ganache: une blockchain de test locale
