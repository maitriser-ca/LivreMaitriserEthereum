...
Nous utilisons maintenant +truffe+ pour compiler le code +METoken+ :
...
[[is_contract]]
Pour détecter si l&#39;adresse de destination est un contrat, l&#39;implémentation de référence ERC223 utilise un petit segment de bytecode en ligne d&#39;une manière plutôt créative :
